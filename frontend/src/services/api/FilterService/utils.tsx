...
export const transformStatusResponseToFilterItems = (status: APPOINTMENT_FILTER_STATE[]) : FilterItem[] => {
  return getBaseCalendarStatusFilterItems().filter((f) => status.includes(f.id as APPOINTMENT_FILTER_STATE));
}

export const transformGridsResponseToFilterItems = (grids: GridFilterResponse[]) : FilterItem[] => {
