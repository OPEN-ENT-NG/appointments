...
export const TOAST_VALUES = {
  ...
  [TOAST_TYPE.COPY_LINK]: {
    i18nKeySuccess: "appointments.toast.copy.link.success",
    i18nKeyError: "appointments.toast.copy.link.error",
  },
  ...
  [TOAST_TYPE.EXPORT_EVENTS]: {
    i18nKeySuccess: "appointments.toast.event.export.all.success",
    i18nKeyError: "appointments.toast.event.export.error",
  },
};
...
export const MAX_DURATION_VERY_SHORT_EVENT = 20;
export const MAX_DURATION_SHORT_EVENT = 30;
export const MAX_DURATION_MEDIUM_EVENT = 45;
