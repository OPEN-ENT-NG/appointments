...
public class Fields {
    ...
    public static final String CAMEL_COLOR = "color";
    public static final String CAMEL_DAILY_SLOTS = "dailySlots";
    public static final String CAMEL_DATE = "date";
    public static final String CAMEL_DAY = "day";
    public static final String CAMEL_DOCUMENT_ID = "documentId";
    public static final String CAMEL_DURATION = "duration";
    ...
    public static final String CAMEL_ID = "id";
    public static final String CAMEL_NAME = "name";
    public static final String CAMEL_OWNER_ID = "ownerId";
    public static final String CAMEL_PERIODICITY = "periodicity";
    public static final String CAMEL_PLACE = "place";
    public static final String CAMEL_PUBLIC_COMMENT = "publicComment";
    public static final String CAMEL_REQUESTER_ID = "requesterId";
    public static final String CAMEL_STATE = "state";
