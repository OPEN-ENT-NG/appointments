...
public class GridPayload {
    ...
    public GridPayload(JsonObject grid){
        this.gridName = grid.getString(Fields.CAMEL_NAME, "");
        ...
        this.color = grid.getString(Fields.CAMEL_COLOR);
        this.structureId = grid.getString(Fields.CAMEL_STRUCTURE_ID,"");

        this.duration = DateHelper.parseDuration(grid.getString(Fields.CAMEL_DURATION,""));

        this.periodicity = Periodicity.from(grid.getInteger(Fields.CAMEL_PERIODICITY,0));
        ...
        this.dailySlots = grid
            .getJsonArray(Fields.CAMEL_DAILY_SLOTS, new JsonArray())
            .stream()
            .map(o -> new DailySlot((JsonObject) o))
            .collect(Collectors.toList());

        this.visioLink = grid.getString(Fields.CAMEL_VISIO_LINK);
        this.place = grid.getString(Fields.CAMEL_PLACE);
    ...
    public String toString() {
        return new JsonObject()
            .put(Fields.CAMEL_NAME, this.gridName)
            ...
            .put(Fields.CAMEL_COLOR, this.color)
            .put(Fields.CAMEL_STRUCTURE_ID, this.structureId)
            .put(Fields.CAMEL_DURATION, DateHelper.formatDuration(this.duration))
            .put(Fields.CAMEL_PERIODICITY, this.periodicity.getValue())
            ...
            .put(Fields.CAMEL_PLACE, this.place)
